...
def display_options_menu(title, options):
    print(f"\n{title}")
...
def convert_pdf_to_docx():
    pdf_files = find_files_by_extension(".pdf")
...
def convert_docx_to_pdf():
    docx_files = find_files_by_extension(".docx")
...
def compress_images():
    image_files = find_files_by_extension((".png", ".jpg", ".jpeg"))
...
def run_main_menu():
    while True:
        display_options_menu("Главное меню", ["Сменить рабочий каталог", "Преобразовать PDF в Docx",
